...
class Feeder(Dataset):
    def __init__(self, data_path, label_path,feature_path,
    ...
    def load_data(self):
        ...
        if self.use_mmap:
            ...
            f1=self.feature.reshape(num,48,31)[:,:,0:14].reshape(num,14*48)
            f2=self.feature.reshape(num,48,31)[:,:,23:].reshape(num,8*48)
            self.feature=np.concatenate((f1,f2),axis=1)
        else:
    ...
    def __getitem__(self, index):
        ...
        return data_numpy, label,feature_numpy, index
