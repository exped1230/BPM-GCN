...
class Model(nn.Module):
    def __init__(self, num_class=4, num_point=16, num_person=1, graph=None, graph_args=dict(), in_channels_p=3,in_channels_m=8):
        ...
        self.fc1_classifier_p = nn.Linear(256+31*48, num_class)
    ...
    def forward(self, x_p,x_m,x_aff):
        ...
        return self.fc1_classifier_p(torch.cat((x_p,x_aff),1)),self.fc2_aff(x_p),self.fc1_classifier_m(x_m)
